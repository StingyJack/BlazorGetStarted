namespace NetFxControllers
{
    ...
    using NetFxTestConsole.ServiceReference1;
    ...
    public class AuthController
    {
        public AuthResult AttemptUserAuth(string userName, string password)
        {
            try
            {
                ...
                using (var svc = new AuthServiceClient(binding, endpointAddress))
                {
...
//    public AuthResult AttemptUserAuthAsync(string userName, string password) => Channel.AttemptUserAuth(userName, password);
...
//    //    public AuthResult AttemptUserAuth(string userName, string password)
//    //    {
//    //        //var asyncResult = AttemptUserAuthBeginInvoke(userName, password);
//    //        //var authResult = AttemptUserAuthEndInvoke(asyncResult);
//    //        //return authResult;
